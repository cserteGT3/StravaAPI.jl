...
function OpenAPI.check_required(o::MetaClub)
    true
end

function OpenAPI.validate_properties(o::MetaClub)
    OpenAPI.validate_property(MetaClub, Symbol("id"), o.id)
    OpenAPI.validate_property(MetaClub, Symbol("resource_state"), o.resource_state)
    OpenAPI.validate_property(MetaClub, Symbol("name"), o.name)
end
